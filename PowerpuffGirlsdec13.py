...
while playAgain in ['yes', 'YES', 'Yes', 'y', 'Y']:
    ...
    while name not in {'Buttercup','buttercup','BUTTERCUP',"Bubbles",'bubbles','BUBBLES','Blossom','blossom','BLOSSOM'}:
        name = input(Fore.WHITE + "Not an eligible player... which Powerpuff girl do you want to be? \n Bubbles, Buttercup, or Blossom? ")
    ...
    while (space < 24):
        ...
        if space == 1:
            ...
            space += 3
            ("You are on space number", space, ". Keep going!")
            ...
            if decision8 in {"Y", "y", "Yes", "yes"}:
                ...
                print("That potion was bad news", name, "!!")
