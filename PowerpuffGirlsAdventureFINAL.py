...
Please change your Spyder Theme to a DARK THEME to be able to see text!
"""
...
def lives():
    if numberoflives == 0:
        ...
        print(Fore.GREEN + "You have", numberoflives, "lives! Wow,", name, "! We underestimated you. Hopefully it will be enough to make it through...")
...
while playAgain in ['yes', 'YES', 'Yes', 'y', 'Y']:
    ...
    while (space < 24):
        ...
        if space == 1:
            ...
            numberoflives -= 1
            decision7 = input(Fore.WHITE + "Do you want revenge on MOJO JOJO for taking a life?! Should you get up and spray him with your pixie stick gun? ")
            ...
            while decision18 not in {"Y","y","yes","Yes","YES","N","n","No","no","NO"}:
            ...
            while decision20 not in {"Y","y","yes","Yes","YES","YES!","yes!","N","n","No","no"}:
                decision20 = input("I don't get what you mean. Are you excited or not?")
            if decision20 in {"Y", "y", "Yes", "yes","YES"}:
                numberoflives -= 1
            ...
            if decision22 == "1":
                print("You cannot beat all the villains at once. You are beaten so painfully... till your new life starts.")  
                numberoflives -= 1
            elif decision22 == "2":
            ...
            print(Fore.RED + "I'm so sorry to inform you that the Professor turned you and everyone else in Townsville into babies and you lost your superpowers.\n Good job though! You've made it this far but sorry, you cannot make it until the end!!\n Wish you a better luck next time!")
            #Set variables to quit from dice roll and print game over message
            space = 25
            numberoflives = 0
        else:
            print(Fore.GREEN + "Congratulations", name, "!! You've made it with", numberoflives, "lives remaining. Now it is time for enjoying Christmas holidays with the other two Powerpuff girls.")    
    ...
    playAgain = input(Fore.WHITE + "**********\nThank you for enjoying our game. Enter Y to play again, any messing with other keys will stop program. ")
    if playAgain not in {'y','Y','yes','YES','Yes'}:
        print("Okay, game over!")
        break